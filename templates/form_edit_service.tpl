        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="form-group">
                    ...
                    <input name="km_prox_service" type="text" class="form-control" value="{$service->km_prox_service}"required>
                </div>
            </div>
            <div class="col-9">
                <div class="form-group">
                    <label><b>Gastos repuestos</b></label>
                    <input name="gastos_repuestos" type="text" class="form-control" value="{$service->gastos_repuestos}" required>
                </div>
            </div>
            <div class="col-9">
                <div class="form-group">
            ...
            <div class="col-9">
                <div class="form-group">
                    ...
                    <input name="descripcion" type="text" style="height:150px;" class="form-control" value="{$service->descripcion}" required>
                </div>
            </div>
        </div>
